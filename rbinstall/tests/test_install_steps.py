...
class GetInstallSteps(TestCase):
    ...
    VIRTUALENV_STEPS = [
        ...
        },
        {
            ...
            'state': ['pip', 'setuptools', 'wheel', '--no-binary',
                      'lxml', 'lxml'],
        },
    ]
    ...
    def test_with_centos_stream_10_x86_64(self) -> None:
        """Testing get_install_steps with CentOS Stream 10 (x86_64)"""
        install_state = self.create_install_state(
            arch='x86_64',
            distro_id='centos',
            distro_families={
    ...
    def test_with_centos_stream_10_aarch64(self) -> None:
        """Testing get_install_steps with CentOS Stream 10 (aarch64)"""
        install_state = self.create_install_state(
            arch='aarch64',
            distro_id='centos',
            distro_families={
    ...
    def test_with_debian_13_x86_64(self) -> None:
        """Testing get_install_steps with Debian 13 (x86_64)"""
        install_state = self.create_install_state(
            arch='x86_64',
            distro_id='debian',
            distro_families={
    ...
    def test_with_debian_13_aarch64(self) -> None:
        """Testing get_install_steps with Debian 13 (aarch64)"""
        install_state = self.create_install_state(
            arch='aarch64',
            distro_id='debian',
            distro_families={
    ...
    def test_with_rocky_linux_10_x86_64(self) -> None:
        """Testing get_install_steps with Rocky Linux 10 (x86_64)"""
        install_state = self.create_install_state(
            arch='x86_64',
            distro_id='rocky',
            distro_families={
    ...
    def test_with_rocky_linux_10_aarch64(self) -> None:
        """Testing get_install_steps with Rocky Linux 10 (aarch64)"""
        install_state = self.create_install_state(
            arch='aarch64',
            distro_id='rocky',
            distro_families={
